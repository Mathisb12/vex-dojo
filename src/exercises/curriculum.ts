  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    lessons: [
      ...
      // ── Lesson 2: Variables & Types ────────────────────────────────────────
      {
        ...
        icon: '🔢',
        description: 'Declare int, float, vector and string variables',
        learnCards: [
          {
            kind: 'learn',
            id: 'learn-var-1',
            title: 'The four basic types',
            body: 'VEX requires you to declare the **type** of every variable. There are four types you\'ll use constantly:\n\n- `int` — whole numbers: `0`, `-3`, `42`\n- `float` — decimal numbers: `0.5`, `3.14`, `-1.0`\n- `vector` — three floats packed together: `{x, y, z}`\n- `string` — text: `"hello"`\n\nThe type keyword always comes **before** the variable name.',
            codeExample: 'int   count  = 10;\nfloat scale  = 2.5;\nvector color = {1.0, 0.5, 0.0};\nstring name  = "my_point";',
            keyPoints: [
              'Always declare the type: int, float, vector, string',
              'Vectors use curly braces: {x, y, z}',
          ...
          },
          {
            ...
            keyPoints: [
              ...
              'Colors are vectors: .x=R, .y=G, .z=B',
              'Math on vectors applies to all 3 components at once',
